...
export interface AppSettings { language: 'zh' | 'en' | 'auto'; theme: 'light' | 'dark' | 'system'; outputDir: 'same' | 'custom'; customOutputDir: string; maxConcurrent: number; openAfterDone: boolean; pandocExtraArgs: string; }
